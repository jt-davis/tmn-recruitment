...
export const homeObjThree = {
    ...
    topLine: 'Tiger Media Network',
    headline: 'Equipment',
    description: 'View all the industry standard equipment that you\'ll get to use.',
    buttonLabel: 'More Info',
    imgStart: false,
...
export const homeObjFour = {
    ...
    lightTextDesc: true,
    topLine: 'Director',
    headline: 'Justin Davis',
    description: '"I\'ve enjoyed working at TMN immensely for the past three years of my college career. I\'ve always said that graduating is a bittersweet moment because while I\'m happy to graduate, I know that TMN will get better next year and even better after that and there\'s a large part of me that is sad I won\'t be there for it. I am proud however at having a chance to be apart of TMN for as long as I did."',
    buttonLabel: 'More Info',
    imgStart: false,
    img: require('../../images/JT.jpg').default,
    alt: 'JT',
    dark: true,
    primary: true,
    darkText: false
